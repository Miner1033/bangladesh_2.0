...
// Cloudinary credentials (⚠️ Not secure, use only for testing!)
  ...
  void signUp() async {
    ...
    try {
      ...
      // 3️⃣ Upload Profile Picture to Cloudinary
      ...
      // 4️⃣ Upload Multiple Photos to Cloudinary
      ...
      // 5️⃣ Store User Data in Firestore
