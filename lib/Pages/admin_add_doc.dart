  ...
  Future<void> addItem() async {
    ...
    if (profilePic == null) {
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('⚠️ Profile picture is required')));
      return;
    }
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        validator: (value) {
          ...
          if (isNumeric) {
            // Bangladeshi phone number regex validation
            String pattern = r'^(?:\+8801|01)[1-9][0-9]{8}$';
